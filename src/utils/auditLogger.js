...
export const ACTION_TYPES = {
  CREATE: { label: 'إضافة', labelZh: '新增', labelEn: 'Create', color: '#10b981', bg: 'rgba(16, 185, 129, 0.12)', border: 'rgba(16, 185, 129, 0.3)' },
  UPDATE: { label: 'تعديل', labelZh: '修改', labelEn: 'Update', color: '#f59e0b', bg: 'rgba(245, 158, 11, 0.12)', border: 'rgba(245, 158, 11, 0.3)' },
  DELETE: { label: 'حذف', labelZh: '删除', labelEn: 'Delete', color: '#ef4444', bg: 'rgba(239, 68, 68, 0.12)', border: 'rgba(239, 68, 68, 0.3)' },
  COPY: { label: 'نسخ', labelZh: '克隆/复制', labelEn: 'Copy', color: '#8b5cf6', bg: 'rgba(139, 92, 246, 0.12)', border: 'rgba(139, 92, 246, 0.3)' },
  RECEIVE: { label: 'استلام', labelZh: '收货', labelEn: 'Receive', color: '#06b6d4', bg: 'rgba(6, 182, 212, 0.12)', border: 'rgba(6, 182, 212, 0.3)' },
  PRINT: { label: 'طباعة', labelZh: '打印', labelEn: 'Print', color: '#3b82f6', bg: 'rgba(59, 130, 246, 0.12)', border: 'rgba(59, 130, 246, 0.3)' },
  EXPORT: { label: 'تصدير', labelZh: '导出', labelEn: 'Export', color: '#14b8a6', bg: 'rgba(20, 184, 166, 0.12)', border: 'rgba(20, 184, 166, 0.3)' },
  SECURITY: { label: 'أمان ومستخدمين', labelZh: '安全与用户', labelEn: 'Security & Users', color: '#ec4899', bg: 'rgba(236, 72, 153, 0.12)', border: 'rgba(236, 72, 153, 0.3)' },
  AUTH: { label: 'تسجيل دخول', labelZh: '身份验证', labelEn: 'Authentication', color: '#6366f1', bg: 'rgba(99, 102, 241, 0.12)', border: 'rgba(99, 102, 241, 0.3)' },
  SETTINGS: { label: 'إعدادات النظام', labelZh: '系统设置', labelEn: 'System Settings', color: '#eab308', bg: 'rgba(234, 179, 8, 0.12)', border: 'rgba(234, 179, 8, 0.3)' },
  RESTORE: { label: 'استعادة طلبية', labelZh: '恢复订单', labelEn: 'Restore Order', color: '#22c55e', bg: 'rgba(34, 197, 94, 0.12)', border: 'rgba(34, 197, 94, 0.3)' },
};

export const SYSTEM_SCREENS = {
  entry: { key: 'entry', nameAr: 'أوامر الإنتاج وتوثيق الطلبات', nameZh: '生产订单与录入向导', nameEn: 'Production Orders & Entry Wizard', icon: '📝', color: '#d4af37' },
  'order-reports': { key: 'order-reports', nameAr: 'تقارير ومطابقة الطلبيات', nameZh: '订单核对与报告', nameEn: 'Order Reports & Matching', icon: '📋', color: '#f59e0b' },
  export: { key: 'export', nameAr: 'مستندات وفواتير التصدير', nameZh: '出口文档与发票', nameEn: 'Export Documents & Invoices', icon: '📤', color: '#60a5fa' },
  receiving: { key: 'receiving', nameAr: 'استلام بضائع الشركة', nameZh: '公司货物入库', nameEn: 'Goods Receiving', icon: '📥', color: '#4ade80' },
  'factory-portal': { key: 'factory-portal', nameAr: 'بوابة صاحب المصنع', nameZh: '工厂门户', nameEn: 'Factory Portal', icon: '🏭', color: '#d4af37' },
  barcodes: { key: 'barcodes', nameAr: 'استخراج وطباعة الباركود', nameZh: '条形码生成与打印', nameEn: 'Barcode Generation & Printing', icon: '🏷️', color: '#fb923c' },
  analytics: { key: 'analytics', nameAr: 'التحليلات الاستراتيجية', nameZh: '战略分析看板', nameEn: 'Strategic Analytics', icon: '📈', color: '#ec4899' },
  reports: { key: 'reports', nameAr: 'التقارير والإحصائيات', nameZh: '统计报告中心', nameEn: 'Reports & Statistics', icon: '📊', color: '#ec4899' },
  'shipping-invoice': { key: 'shipping-invoice', nameAr: 'فاتورة الشحن', nameZh: '装运发票', nameEn: 'Shipping Invoice', icon: '🧾', color: '#06b6d4' },
  'packing-list': { key: 'packing-list', nameAr: 'فاتورة الجمارك (بيان التعبئة)', nameZh: '装箱单 (海关报关单)', nameEn: 'Packing List (Customs Declaration)', icon: '📦', color: '#10b981' },
  'warehouse-receipt': { key: 'warehouse-receipt', nameAr: 'تقرير استلام البضائع (المستودع)', nameZh: '仓库入库单据', nameEn: 'Warehouse Goods Receipt', icon: '🏢', color: '#f59e0b' },
  admin: { key: 'admin', nameAr: 'لوحة الإدارة والمستخدمين', nameZh: '管理面板与用户管理', nameEn: 'Admin Panel & Users', icon: '👑', color: '#a78bfa' },
  auth: { key: 'auth', nameAr: 'شاشة تسجيل الدخول', nameZh: '登录认证界面', nameEn: 'Authentication & Login', icon: '🔐', color: '#6366f1' },
};
